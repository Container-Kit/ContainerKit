...
<div class="flex items-center justify-center min-h-screen p-4">
    <Card.Root class="w-full max-w-md">
        <Card.Header class="text-center">
            ...
            <Card.Title>Unsupported Version</Card.Title>
            <Card.Description>Your macOS version is not supported by <strong>ContainerKit</strong>.</Card.Description>
        </Card.Header>
        <Card.Content class="space-y-4">
            <div class="text-sm text-muted-foreground">
                <p>
                    <strong>ContainerKit</strong> requires <span class="italic">macOS 26</span> or later with Apple
                    Silicon support.
                </p>
            </div>
